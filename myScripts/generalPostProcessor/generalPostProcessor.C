...
Application
  This is a general purpose post processor which runs the functions listed in the controlDict file as a postProcess in case you forgot to run it while doing the simulation.
Original solver by Eelco van Vliet
